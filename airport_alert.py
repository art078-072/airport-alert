...
# --- Закрытия -------------------------------------------------------------------------
# Сочи отключён по просьбе пользователя: аэропорт закрывался по несколько раз в сутки.
# Чтобы вернуть — добавьте "aeroaer" в CHANNELS, "Сочи" в AIRPORTS и delayed_aer в DELAY_SOURCES.
...
OWN_CHANNEL = {"svo_online": "Шереметьево", "vnukovoairport_VKO": "Внуково", "pulkovo_led": "Пулково"}
